                ...
                <div class="page-header">
                    <div class="row">
                        ...
                        <div class="col-sm-5 col">
                            <a href="{{ route('specialization.upsert') }}" class="btn btn-primary float-end mt-2">{{ __('pages.add_specialization_minor') }}</a>
                        </div>
                    </div>
                </div>
                <!-- /Page Header -->
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="table-responsive">
                                    <form class="form" action="{{ route('specialization.filter') }}" method="get">
                                    ...
                                    <table  class="table table-hover table-center mb-0"  filter="{{ route('specialization.filter') }}">
                                        <thead>
                                            <tr>
                                                <th></th>
                                                <th>{{ __('pages.name') }}</th>
                                        ...
                                        @foreach($specialites as $specialization)
                                            <tr class="record">
                                                ...
                                                <td  class="text-end">
                                                    <div class="actions">
                                                        <a href="{{ route('specialization.upsert',['specialization' => $specialization->id]) }}" class="btn btn-sm bg-success-light" >
                                                            <i class="fe fe-pencil"></i> {{ __('pages.edit') }}
                                                        </a>
                                                        <a   class="btn btn-sm bg-danger-light btn_delete" route="{{ route('specialization.delete',['specialization' => $specialization->id]) }}">
