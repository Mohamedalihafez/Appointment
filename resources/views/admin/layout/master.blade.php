...
<html lang="en">
    <head>
        ...
        <title>TASK APPOINTMENT - @yield('title')</title>
        {{-- Font --}} 
            ...
            <div class="sidebar-inner slimscroll">
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
                        ...
                        <li>
                            <a href="{{ route('specialization') }}" class="page_link {{is_active('specialization')}} ">
                                <i class="fe fe-file"></i>
                                <span>{{ __('pages.specializations') }}</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('schedule') }}" class="page_link {{is_active('schedule')}} ">
                                <i class="fe fe-clock"></i>
                                <span>{{ __('pages.schedules') }}</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('user') }}" class="page_link {{is_active('user')}} ">
                                <i class="fe fe-users"></i>
                                <span>{{ __('pages.doctors') }}</span>
                            </a>
                        </li>
